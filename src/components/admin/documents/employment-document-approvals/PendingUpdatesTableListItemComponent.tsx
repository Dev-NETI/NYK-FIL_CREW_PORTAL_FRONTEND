...
interface PendingUpdatesTableListItemComponentProps {
  update: EmploymentDocumentUpdate;
  onViewUpdate: (update: EmploymentDocumentUpdate) => void;
}

export default function PendingUpdatesTableListItemComponent({
  update,
  onViewUpdate,
}: PendingUpdatesTableListItemComponentProps) {
