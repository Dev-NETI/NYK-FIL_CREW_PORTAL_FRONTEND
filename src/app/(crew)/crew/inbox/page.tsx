...
const crewMembers = [
  { id: 1, name: "Jose Rizal" },
  { id: 2, name: "Maria Santos" },
  { id: 3, name: "Juan dela Cruz" },
  { id: 4, name: "Ana Reyes" },
  { id: 5, name: "Carlos Mendoza" },
  { id: 6, name: "Pedro Garcia" },
  { id: 7, name: "Sofia Lopez" },
];
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-baseline justify-between gap-2">
                      <h3 className={`text-sm font-semibold text-gray-900 truncate ${conv.unread ? "font-bold" : ""}`}>
                        {conv.name}
                      </h3>
                    ...
                    <p className={`text-sm text-gray-600 truncate mt-0.5 ${conv.unread ? "font-medium" : ""}`}>
                      {conv.lastMessage}
                    </p>
                  </div>
              ...
              <div className="p-4 border-b border-gray-200 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    {activeConversation.active ? "Active now" : "Last seen 2h ago"}
                  </p>
                </div>
