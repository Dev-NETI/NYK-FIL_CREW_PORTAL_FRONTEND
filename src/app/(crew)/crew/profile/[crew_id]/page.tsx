              ...
              <div className="lg:flex-1 text-center lg:text-left">
                ...
                <p className="text-lg sm:text-xl text-blue-200 mb-4 sm:mb-6">
                  {profile.profile?.crew_id || profile.crew_id
                    ? `Crew ID: ${profile.profile?.crew_id || profile.crew_id}`
                    : "No crew assignment"}
                </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-orange-50 rounded-xl p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                          <label className="block text-sm font-semibold text-gray-700 mb-2">
                            Emergency Contact (Mobile No., Relation to Seafarer)
                          </label>
                          <p className="text-gray-900 py-3 px-4 bg-white rounded-xl border border-gray-200">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            This page now displays data from the new normalized
                            database structure, providing better organization
                            and security for user information.
                          </p>
                        </div>
                      </div>
                    </div>
