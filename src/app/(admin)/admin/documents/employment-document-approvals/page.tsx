...
export default function EmploymentDocumentApprovalsPage() {
  ...
  const [selectedUpdate, setSelectedUpdate] =
    useState<EmploymentDocumentUpdate | null>(null);
    ...
    try {
      ...
      const data =
        filter === "pending"
          ...
          : await EmploymentDocumentApprovalService.getAllUpdates();
  ...
  const handleViewUpdate = (update: EmploymentDocumentUpdate) => {
  ...
  const handleApprove = async (id: number) => {
    try {
      const response = await EmploymentDocumentApprovalService.approve(id);
      if (response.success) {
  ...
  const handleReject = async (id: number, reason: string) => {
    try {
      const response = await EmploymentDocumentApprovalService.reject(id, {
