        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <a href="/admin/applications" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                View all
              </a>
            </div>
          </div>
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">John Dela Cruz</p>
                  <p className="text-xs text-gray-600">Able Seaman Application</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Chief Engineer Application</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                  <span className="text-purple-600 font-semibold text-sm">RG</span>
                </div>
                <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-600 group-hover:text-blue-600">Add New Crew</p>
                </div>
              </a>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-600 group-hover:text-green-600">Review Applications</p>
                </div>
              </a>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-600 group-hover:text-purple-600">Upload Documents</p>
                </div>
              </a>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-600 group-hover:text-yellow-600">Generate Report</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h4 className="text-sm font-semibold text-gray-900 mb-1">Database</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-sm font-semibold text-gray-900 mb-1">Active Users</h4>
